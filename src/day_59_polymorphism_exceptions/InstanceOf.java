...
import day_57_abstraction_polymorhism.shapes.Circle;
import day_57_abstraction_polymorhism.shapes.Shape;
import day_57_abstraction_polymorhism.shapes.Square;
...
public class InstanceOf {
    public static void main(String[] args) {
        ...
        System.out.println(shape.getClass().getName()); //this is class name of object and package name
