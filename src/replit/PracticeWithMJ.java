...
public class PracticeWithMJ {
    public static void main(String[] args) {
        ...
        int[] num2 = num;   //3,6,3,1
        System.out.println(Arrays.toString(num2));
        num2 = new int[5]; // it could be different size   //length 0,0,0,0,0,
        ...
        int size = name.length; // size of array  // 4
        name[0] = name[2];     //javad
        System.out.println(Arrays.toString(name)); // javad mohammad javad semati
